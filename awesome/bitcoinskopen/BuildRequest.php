<?php
    ...
    */
    $payment = $mollie->payments->create(array(
        "amount"       => $btcAmount,
        "description"  => "Sending to " . $btcAddress,
        "redirectUrl"  => "{$protocol}://{$hostname}{$path}/Result.php?order_id={$order_id}",
        "metadata"     => array(
        "order_id" => $order_id,
    ),
    ));
...
We'll send them to : <?php echo $_POST["txtAddress"]; ?>
